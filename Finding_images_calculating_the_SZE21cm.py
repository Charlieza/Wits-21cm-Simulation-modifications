...
wd = '/home/charles/Documents/simulation_test_folder/data'
os.chdir(wd)
...
for i in os.listdir(os.getcwd()):
        if i.startswith('delta_T_v3_no_halos'):
                ...
                s = '/home/charles/Documents/simulation_test_folder/data2'
                os.chdir(s)
                        ...
                        for i in range (len(redshift)):
                            ...
                            if redshift[i] == z:
                                ...
                                def box_with_cluster(ndim):
                                    ...
                                    fd = open('/home/charles/Documents/simulation_test_folder/data/'+filename, 'rb')
                                ...
                                def readslice(ndim):
                                    shape = (ndim,ndim,ndim)
                                    fd = open('/home/charles/Documents/simulation_test_folder/data2/'+myfile, 'rb')
                                    print myfile
                                    dI = (((2*(k*(f**2))/(c**2)))*(10**-3)*(10**26)*(1.18*(10**-7))*(np.fromfile(file=fd, dtype= np.dtype('f4')).reshape(shape)))
                                    fd.close()
                                    return dI
                                ...
                                b = np.mean(SZET[139:250,139:250,139:250])
