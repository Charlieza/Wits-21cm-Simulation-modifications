                    ...
                    if k.startswith('delta_T_v3_no_halos_z'+str('%06.2f'%(z+0.05))):
                        ...
                        for i in range (len(redshift)):
                            ...
                            if redshift[i] == z:
                                ...
                                plt.xlabel('Mpc')
                                plt.ylabel('Mpc')
                                plt.imshow(ff[0,:,:],cmap = cm.jet, vmin=b, vmax=a)
                                plt.colorbar()
                                ...
                                plt.xlabel('Mpc')
                                plt.ylabel('Mpc')
                                plt.imshow(fs[100,:,:],cmap = cm.jet, vmin=b, vmax=a)
                                plt.colorbar()
                                ...
                                plt.xlabel('Mpc')
                                plt.ylabel('Mpc')
                                plt.imshow(fz[100,:,:],cmap = cm.jet, vmin=b, vmax=a)
                                plt.colorbar()
                                ...
                                plt.xlabel('Mpc')
                                plt.ylabel('Mpc')
                                plt.imshow(fk[100,:,:],cmap = cm.jet, vmin=b, vmax=a)
                                plt.colorbar()
                                plt.savefig(location + 'forground_box_at_' +''.join(v2), bbox_inches='tight')
                                #plt.show()
                                plt.close()
