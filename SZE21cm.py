...
wd = '/mnt/storage1/simulations/charles/data'
os.chdir(wd)
...
for i in os.listdir(os.getcwd()):
        if i.startswith('delta_T_v3_no_halos'):
            ...
            location = '/home/charlest/Desktop/pics/'
            ...
            for i in range (len(redshift)):
                ...
                if redshift[i] == z:
                    ...
                    def readslice(ndim):
                        ...
                        dI = (2*(k*(f**2))*(1/(c**2))*((data)*(10**(-3)))*(10**26))/(8.46*(10**-8))                        fd.close()
                        return dI
                    fb =  readslice(256)
                    ...
                    SZEI = fc - (fa + fb)
                    SZET = (SZEI*(10**(-26)))*(c**2)*(1/((2*k*(f**2))))*(10**3)
